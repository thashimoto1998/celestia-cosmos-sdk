...
* [basecoin] NewBasecoinApp takes a `dbm.DBConnection` and uses namespaced DBs for substores
...
* [basecoin] NewBasecoinApp takes a `map[string]dbm.DBConnection` as temporary measure
