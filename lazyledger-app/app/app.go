...
import (
	...
	appparams "github.com/cosmos/cosmos-sdk/lazyledger-app/app/params"
	"github.com/cosmos/cosmos-sdk/lazyledger-app/x/lazyledgerapp"
	lazyledgerappkeeper "github.com/cosmos/cosmos-sdk/lazyledger-app/x/lazyledgerapp/keeper"
	lazyledgerapptypes "github.com/cosmos/cosmos-sdk/lazyledger-app/x/lazyledgerapp/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/.lazyledgerapp")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	lazyledgerappKeeper lazyledgerappkeeper.Keeper
...
func New(
	...
	app.mm = module.NewManager(
		...
		transferModule,
		lazyledgerapp.NewAppModule(appCodec, app.lazyledgerappKeeper),
...
func (app *App) RegisterTxService(clientCtx client.Context) {
	...
	client, err := rpchttp.New(config.Get("rpc.laddr").(string), "/websocket")
	if err != nil {
		panic(err)
	}
