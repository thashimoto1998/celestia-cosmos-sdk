...
type QueryEvidenceRequest struct {
	...
	EvidenceHash github_com_lazyledger_lazyledger_core_libs_bytes.HexBytes `protobuf:"bytes,1,opt,name=evidence_hash,json=evidenceHash,proto3,casttype=github.com/celestiaorg/celestia-core/libs/bytes.HexBytes" json:"evidence_hash,omitempty"`
}
